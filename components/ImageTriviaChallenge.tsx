...
const ImageTriviaChallenge: React.FC<ImageTriviaChallengeProps> = ({
  onComplete,
  challengeTitle,
}) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const correct =
      ...
      IMAGE_TRIVIA_CHALLENGE.answer.toLowerCase();
  ...
  return (
    <div className="p-8 bg-black/30 backdrop-blur-xl border border-white/10 rounded-2xl shadow-glass text-center">
      ...
      <p className="text-gray-300 mb-2 text-lg">
        {IMAGE_TRIVIA_CHALLENGE.question}
      </p>
      <p className="text-gray-400 mb-6 text-md">
        Example: 32.087 (3 decimal places)
      </p>
